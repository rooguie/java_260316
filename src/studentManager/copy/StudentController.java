...
public class StudentController implements StudentProgram {
	...
	public void addStudent() {
		student.add(new Student("STD2601", "홍길동", 21, "010-1234-5678", "서울시 강남구"));
		student.add( new Student("STD2602", "강민지", 22, "010-9876-5432", "부산시 해운대구"));
		student.add(new Student("STD2603", "오윤석", 20, "010-5555-4444", "경기도 수원시"));
	}

	// 과목 더미데이터
	public void addSubject() {
		subList.add(new Subject("SUB001", "자바 프로그래밍", "2026-1", "김철수", "A강의실"));
		subList.add(new Subject("SUB002", "데이터베이스 기초", "2026-1", "이영희", "B강의실"));
		subList.add(new Subject("SUB003", "운영체제론", "2026-2", "박지성", "C강의실"));
		subList.add(new Subject("SUB004", "인공지능 개론", "2026-1", "최수호", "D강의실"));
		subList.add(new Subject("SUB005", "알고리즘 실습", "2026-2", "정나래", "A강의실"));
